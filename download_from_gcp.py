...
CATEGORIES = [
    ...
    'asian', 'ass', 'babe', 'beautiful', 'bondage', 'brazilian', 'college', 'cosplay', 'ebony', 'european',
    'girlfriend', 'glamour', 'japanese', 'latex', 'latina', 'nipples', 'nude', 'oiled', 'sports', 'tattoo', 'teen',
...
def download_category(category_blobs, destination_folder, force_download, pbar_position):
    ...
    with tqdm(total=len(category_blobs), desc=f"Category {category_blobs[0].split('/')[0]}",
              position=pbar_position) as pbar:
