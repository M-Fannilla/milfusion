...
GALLERIES_MAP = {
    ...
    'amateur': remove_tag,
    'anal': ['anal sex', ],
    'anal gape': remove_tag,
    'armpit': remove_tag,
    'asian': keep_tag,
    'ass': keep_tag,
    'ass fucking': ['anal sex'],
...
FIXED_GALLERIES_MAP = {
    'ai': remove_gallery,
    'amateur': remove_tag,
    'anal': ['anal sex', 'intercourse'],
    'anal gape': remove_tag,
    'armpit': remove_tag,
    'asian': keep_tag,
    'ass': keep_tag,
    'ass fucking': ['anal sex', 'intercourse'],
    'ass licking': ['anilingus'],
    'asshole': remove_tag,
    'babe': remove_tag,
    'babysitter': remove_tag,
    'ball licking': ['fellatio', ],
    'ballerina': remove_gallery,
    'bath': keep_tag,
    'bbc': ['black penis', ],
    'bbw': ['big woman', ],
    ...
    'dildo': ['dildo', 'sex toys'],
    'doctor': remove_tag,
    'doggy style': ['doggy style (sex position)', ],
    'double penetration': ['double penetration', 'intercourse', 'anal sex', 'threesome'],
    'dress': ['dress', ],
    'ebony': keep_tag,
    'emo': remove_gallery,
    'erotic': remove_tag,
    ...
    'flexible': remove_tag,
    'footjob': keep_tag,
    'gangbang': ['group sex', 'intercourse'],
    'gay': remove_gallery,
    'girlfriend': remove_tag,
    'glamour': remove_tag,
    'glasses': keep_tag,
    ...
    'mature': keep_tag,
    'milf': keep_tag,
    'missionary': ['missionary (sex position)', 'intercourse'],
    'mmf': ['group sex', 'threesome', 'double penetration'],
    'model': remove_tag,
    'mom': ['milf', ],
    'natural tits': remove_tag,
    'nipples': ['naked breasts', ],
    'non nude': ['clothed', ],
    'nun': remove_gallery,
    'nurse': keep_tag,
    'office': remove_tag,
    ...
    'spanking': remove_gallery,
    'sports': keep_tag,
    'spreading': remove_tag,
    'squirting': remove_tag,
    'ssbbw': ['big woman', ],
    'step brother': remove_tag,
    'step sister': remove_tag,
    'stepmom': ['milf', ],
    'stockings': keep_tag,
    'strap on': ['strap on', 'sex toys'],
    'stripper': remove_gallery,
    'swingers': ['group sex', ],
    'tall': remove_tag,
    'tattoo': keep_tag,
    ...
    'thong': keep_tag,
    'threesome': ['threesome', 'group sex', ],
    'tiny tits': ['small breasts', ],
    'titjob': keep_tag,
    'tribbing': remove_gallery,
    'twink': remove_gallery,
    'twins': remove_tag,
    'underwater': remove_gallery,
    'undressing': remove_tag,
    'uniform': remove_tag,
    'upskirt': remove_tag,
    'vintage': remove_gallery,
    'voyeur': remove_gallery,
